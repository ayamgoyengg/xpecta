...
class CovidTipsPage extends StatefulWidget {
  const CovidTipsPage({super.key});

  @override
  State<CovidTipsPage> createState() => _CovidTipsPageState();
}

class _CovidTipsPageState extends State<CovidTipsPage> {
  @override
