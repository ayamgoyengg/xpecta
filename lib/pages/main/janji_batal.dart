...
class JanjiBatalPage extends StatefulWidget {
  const JanjiBatalPage({super.key});

  @override
  State<JanjiBatalPage> createState() => _JanjiBatalPageState();
}

class _JanjiBatalPageState extends State<JanjiBatalPage> {
  @override
